...
<div id="Akun_Control">
	<div class="container">
    <br>
    <h3 class="w3l-title"> Kontrol Akun </h3>
    
    <a href="akun_tambah.php"> <button class="btn"> Tambah Akun </button> </a>
    <div>
    	<table class="table table-bordered text-center">
        <tr>
        	<td><b> Username </td>
            <td width="150"><b> Jenis Akun </td>
...
while ($data=mysqli_fetch_array($hasil))
{
	...
	echo "<td width='100'><a href='akun_hapus.php?kode=$data[username]'> Hapus</a></td>
</TR>";
}
